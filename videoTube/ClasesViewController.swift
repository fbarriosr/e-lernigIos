...
//  videoTube
//
//  Created by Francisco Barrios Romo on 22-03-18.
//  Copyright © 2018 RentalApps. All rights reserved.
//

import UIKit

class ClasesViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, XMLParserDelegate {
    ...
    func tableView(_ tv:UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        img1.image = UIImage(named: "video")!
